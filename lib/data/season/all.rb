SeasonTemplate.load([
  ...
  { :id => :dark,
    :name => "The Long Dark",
    :style => :dark,
    :description => "The black stretches above you. It is pierced by only three faint sources of light - two small spots near other, The Twins, almost directly above, and The Herald in its usual spot. The Dirge, the final star to appear in the sky, has shown itself, hanging low where the sun disappeared. Aside from these four stars, the sky is nothing but a pitch black canvas that has been draped across the land. All around you is darkness and cold and the howling wind that pulls the heat from your body.",
    :to => :late_dark,
  },
  { :id => :late_dark,
    :name => "The Long Dark",
  ...
  { :id => :late_dawn,
    :name => "Break",
    :style => :twilight,
    :description => "The sun peeks at last above the horizon, and though the shadows are long there is light once more. The Twins have faded from the sky, leaving only the Dirge and the spot of blackness that surrounds it. The last of the ice has melted, and animals begin to move through the steadily greening wood. Life is returning to the world once more."
  },
  { :id => :early_summer,
    :name => "Summer",
    :style => :summer,
